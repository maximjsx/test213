...
const ACHIEVEMENTS = [
  ...
  { id: 'sage', title: 'Sage', icon: '/icons/lightning.png', unit: 'coins earned', goals: [100, 500, 1500, 5000, 10000],
    value: s => coinsSince(s.coinsByDay) },
  ...
  { id: 'scribe', title: 'Scribe', icon: '/icons/check.svg', unit: 'lessons', goals: [5, 15, lessonCount],
