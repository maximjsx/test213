...
const ACTIONS = {
  ...
  typingDone(s, a, ctx) {
    if (!isInt(a.words, 0, ECONOMY.typingMaxWords) || !isInt(a.wpm, 0, 250) || !isInt(a.accuracy, 0, 100)) return { error: 'bad_score' }
    ...
    return { state: { ...next, typingBest: { wpm: Math.max(best.wpm || 0, a.wpm) } }, coins }
  },
...
export const TIMED = {
  ...
  typingDone: { kind: 'typing', ref: () => 'typing', minMs: () => 25000 },
}
