...
const QUEST_POOL = [
  ...
  { id: 'lessons_2',    icon: '/icons/check.svg', title: 'Finish 2 lessons',          goal: 2,  reward: { type: 'coins', amount: 15 } },
  { id: 'lessons_3',    icon: '/icons/check.svg', title: 'Finish 3 lessons',          goal: 3,  reward: { type: 'coins', amount: 20 } },
