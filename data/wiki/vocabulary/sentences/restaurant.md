> **Искам** […], 'I want' is not really polite.

> Instead use 'ще желая/ бих желал' or just or simply omit the 'искам'

| Bulgarian | English |
|----|----|
| Ще желая една баница, моля. | I would like a banitsa, please. |
| Какво има за пиене? | What do you have to drink? |
...
| Имате ли вегетариански опции? | Do you have vegetarian options? |
| Мога ли да взема десерт? | Can I get dessert? |
| Какво е включено в това ястие? | What is included in this dish? |
| Ще желая маса за двама, моля. | I would like a table for two, please. |
| Може ли да резервирам маса? | Can I reserve a table? |
| Ще желая да си поръчам предястие. | I would like to order an appetizer. |
...
| Каква е рецептата за това ястие? | What is the recipe for this dish? |
| Храната е прекрасна! | The food is delicious! |
| Може ли да ми препоръчате нещо? | Can you recommend something to me? |
| Искам да поръчам ястие за вземане вкъщи. | I would like to order takeout. |
...
| Какъв е вашият най-популярен десерт? | What is your most popular dessert? |
| Искам да направя резервация за специално събитие. | I want to make a reservation for a special event. |
| Храната беше вкусна | The food was delicious |
