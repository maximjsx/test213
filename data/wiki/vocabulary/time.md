...
| редовно | regularly |
| обикновено | usually |
| преди 10 дни | 10 days ago |
| след 3 години | after/in 3 years |
| от време на време | from time to time |
| по-рано | earlier |
| сега | now |
| вчера | yesterday |
| следващата седмица | next week |
...
| Пак | Again |
| Отново | Again |
| След това/после | After that/after |
| До после | See you later |
...
### Week-related Phrases

| Bulgarian | English |
|----|----|
| седмица | week |
| Кой ден е днес? | What day is it today? |
| Днес е … | Today is … |
...
| есен | autumn |
| зима | winter |
| през пролетта | in spring |
| през лятото | in summer |
| през есента | in autumn |
| през зимата | in winter |
