...
const ITEMS = [
  ...
  },
  {
    ...
    match: p => startsWithAny(p, ['/wiki', '/glossary', '/watch', '/about-bulgarian', '/gallery']),
...
const SHOW_ON = ['/topic', '/level', '/practice', '/words', '/letters', '/decks', '/wiki', '/glossary', '/watch', '/about-bulgarian', '/gallery', '/leaderboard', '/profile', '/u']
